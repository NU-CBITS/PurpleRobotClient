function PurpleRobot(a){a=a||{};this.className="PurpleRobot";this._serverUrl=a.serverUrl||"http://localhost:12345/json/submit";this._script=a.script||""}PurpleRobot.apiVersion="1.5.4.1";PurpleRobot.prototype._apiMethod=function(a){return new PurpleRobot({serverUrl:this._serverUrl,script:[this._script,"PurpleRobot."+a+";"].join(" ").trim()})};PurpleRobot.prototype._stringify=function(a){return null!==a&&"object"===typeof a&&a.className===this.className?a.toStringExpression():JSON.stringify(a)};
